    ...
    <>
      ...
      <section className="about-wrapper">
        <div>
          ...
          ></div>
          <div>
            <h1>About Yaks Roofing Systems</h1>
          Yaks Roofing Systems Limited is a registered company that has now
        ...
        <div>
          <div>
          <h1>Our Vision</h1>
          The vision of Yaks Roofing Systems is to become a one stop shop
          for all types of durable roofing sheets and accessories.
          </div>
          <div>
            <h1>Our Materials</h1>
          As Yaks Roofing materials are sourced from credible overseas
          ...
          <div>
          <h1>Our Mission</h1>
          The mission of Yaks Roofing Systems is to provide good customer
